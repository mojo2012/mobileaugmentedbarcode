 ...
 * purpose binarizer for uses outside ZXing. NOTE: This class is still
 * experimental and may not be ready for prime time yet.
 * 
...
public final class LocalBlockBinarizer extends Binarizer {
	...
	// TODO: If getBlackRow() calculates its own values, removing sharpening
	// here.
	@Override
